...
const ScoreView: React.FC<ScoreViewProps> = (props) => {
    ...
    useEffect(() => {
        ...
        // VexFlow Renderer - größere Fläche für Demo
        ...
        // Triole: 3 Achtelnoten auf 2 Achtelnoten-Zeiten (= 1 Viertelnote)
        const tripletNotes = [
            new StaveNote({ keys: ['c/5'], duration: '8' }),
            new StaveNote({ keys: ['d/5'], duration: '8' }),
            new StaveNote({ keys: ['e/5'], duration: '8' }),
        ...
        const bassNotes4 = [
            new StaveNote({ keys: ['c/3'], duration: 'qr', clef: 'bass' }), // Viertelpause
            new StaveNote({ keys: ['d/3'], duration: 'hr', clef: 'bass' }), // Halbe Pause
    ...
    }, []); // Runs once on mount - demo is independent of midiEvents
